...
class CNN:
  ...
  def __init__(self, configfile, train = False):
    ...
    self.y_reshaped = self.y.reshape((self.batch_size, ))
    ...
    self.layer2 = HiddenLayer(rng, input=layer2_input, n_in=3 * nkerns[0] * sizeAfterPooling + self.addInputSize,
    ...
    self.paramList = [self.layer3.params, self.layer2.params, self.layer0a.params]
    self.params = []
